...
public class SearchPageObject extends MainPageObject {
    ...
    public void clickByArticleWithSubstring(String substring) {
        String searchResultXpath = getResultSearchElement(substring);
        this.waitForElementAndClick(By.xpath(searchResultXpath), "Cannot find and click the search result with substring" + substring, 10);
    }
    ...
    public void waitForEmptyResultsLabel() {
        this.waitForElementPresent(
                ...
                "CANNOT find the empty result element",
                15
        );
    }

    public void assertThereIsNoResultOfSearch() {
        this.assertElementNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "There should be no any results");
    }
}
